...
COMPONENT_PATH = PROJECT_ROOT / "custom_components" / "orvibo_smart_control"
STATE_VERSION = 1
...
def _load_component_modules() -> tuple[Any, Any, Any, Any]:
    ...
    package_name = "orvibo_smart_control_audit_runtime"
...
def _https_client_module() -> Any:
    ...
    return importlib.import_module("orvibo_smart_control_audit_runtime.https_client")
